%-*- texinfo -*-
%@deftypefn {Function file} {@var{cmd},@var{opts}} = pfire_parse_cmd( @var{a_string} )
%This function parses a string into a command and arguments. everything behind an hash sign is ignored as a comment.
%@seealso{ pfire_input_from_prompt, pfire_input_from_cf }
%end deftypefn

function [cmd, arguments] = pfire_parse_cmd( a_string )
