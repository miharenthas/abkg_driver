%-*- texinfo -*-
%@deftypefn {Function file} {[@var{PDG},@var{energy},@var{solid_angle},@var{event_specs},@var{out_file}}]} = pfire_input_from_cf( @var{config_file} )
...
%@seealso{ pfire_input_from_prompt, pfire_parse_cmd }
%@end deftypefn

function [ PDG, energy, solid_angle, event_specs, out_file ] = upi_input_from_cf( cf_name )
